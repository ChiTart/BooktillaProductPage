...
sr.reveal(`.products__card` , {origin: 'top'})
sr.reveal(`.specs__data, .branded__animate`, {origin: 'left', interval: 100})
sr.reveal(`.specs__img, .branded__img`, {origin: 'right'})
sr.reveal(`.bookbox__img`, {origin: 'left'})
sr.reveal(`.bookbox__data`, {})